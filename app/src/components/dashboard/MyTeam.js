        ...
        return(
            <section>
                <section className="row mt-3 mx-1">
                    <section className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-9">
                        ...
                        <div className="mb-3 card">
                            ...
                            <div className="px-3 pt-2 pb-0 card-body">
                                <ul className="pl-4 my-0">
                                    <li><p className="my-0">Bookings: 0</p></li>
                                    <li><p className="my-0">Revenue: $0</p></li>
                                    <li><p className="my-0 mb-2">Commission: $0</p></li>
                                </ul>
                            </div>
                        </div>
                        <div className="mb-3 card">
                            ...
                            <div className="px-0 pt-2 pb-0 card-body">
                                <ul className="col-12 mt-0 mb-2">
                                    <li className="row">
                                        <section className="my-0 col-12 text-center">
                                        You have no Team Members, invite your network and increase your earnings.
                                        <br></br>
                                        </section>
                                    </li>
                                    <li className="row">
