...
class Dashboard extends Component {
  ...
  render() {
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="inputName" placeholder="Client Name"></input>
    </div>
    <div class="form-group col-md-4">
      
    <input type="email" class="form-control" id="inputName" placeholder="Client Name"></input>
    </div>
