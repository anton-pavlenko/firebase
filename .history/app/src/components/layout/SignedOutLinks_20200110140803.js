...
class SignedOutLinks extends Component {
    ...
    render(){
        return(
            ...
            <div className="login">
                <form onSubmit={this.handle} className="form-signin text-center align-middle">
                    ...
                    <div className="form-group">
                        <section>
                            ...
                            <input id ="email_field" name="email" placeholder="Email" required="" type="text" className="form-control" value={this.state.value} onChange={this.handleChange} />
                        </section>
                            <section>
                                <label className="sr-only">Password</label>
                                <input id="password_field" name="password" placeholder="Password" required="" type="password" className="form-control" value={this.state.value} onChange={this.handleChange} />
                            </section>
                    </div>
