                                                    ...
                                                    <div className="tab-content">
                                                        <div className="tab-pane active">
                                                            <div className="card-body">
                                                                ...
                                                                <section class="row text-center"><section class="col-12"><button type="submit" class="btn btn-primary" style="border: 2px solid rgb(255, 255, 255); border-radius: 0.25rem;">Submit</button></section></section>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>    
