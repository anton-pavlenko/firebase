                                                        ...
                                                        <div className="tab-pane active">
                                                            <div className="card-body">
                                                                ...
                                                                <section className="row form-group">
                                                                    <section className="col-12">
                                                                    <div role="group" class="btn-group" style="border: 2px solid rgb(255, 255, 255); border-radius: 0.25rem;"><button type="button" class="btn btn-primary active">Round Trip</button><button type="button" class="btn btn-primary">One Way</button></div>
                                                                    </section>
                                                                </section>
                                                                </form>
                                                            </div>
