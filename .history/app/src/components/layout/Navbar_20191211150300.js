      ...
      ( 
        ...
        >
          <ul class="w-100 justify-content-center navbar-nav">
            ...
            <li class="nav-item"><p class="nav-link text-white pb-1 my-0" style="font-size:16px;font-weight:300">Recent Bookings</p></li><li class="nav-item"><p class="nav-link text-white pb-1 my-0" style="font-size:16px;font-weight:300">Services</p></li><li class="nav-item"><p class="nav-link text-white pb-1 my-0" style="font-size:16px;font-weight:300">FAQs</p></li></ul>
        </div>
      </nav>
