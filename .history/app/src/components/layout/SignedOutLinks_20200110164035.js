                    ...
                    <div className="form-group">
                        <section>
                            ...
                            <section>
                                ...
                                <input id="password_field" name="password" value= placeholder="Password" required="" type="password" className="form-control" value={this.state.value} onChange={this.handleChange} />
                            </section>
                    </div>
