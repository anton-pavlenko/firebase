                ...
                <form class="form-signin text-center align-middle">
                    ...
                    <div class="form-group">
                        <section>
                            ...
                            <input id ="sign-in" name="username" placeholder="Username" required="" type="text" class="form-control" value={this.state.value} onChange={this.handleChange} />
                        </section>
                            <section>
                                <label class="sr-only">Password</label>
                                <input id="sign-out" name="password" placeholder="Password" required="" type="password" class="form-control" value={this.state.value} onChange={this.handleChange} />
                            </section>
                    </div>
