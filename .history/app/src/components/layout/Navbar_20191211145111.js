  ...
  return (
    ...
    {!isAuthHome ? 
      ...
      <nav class="navbar-custom justify-content-center navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="w-style w-100 collapse navbar-collapse">
          <ul class="w-100 justify-content-center navbar-nav">
            <li class="nav-item"><p class="nav-style nav-link text-white pb-1 my-0">How It Works</p></li>
            <li class="nav-item"><p class="nav-style nav-link text-white pb-1 my-0">Recent Bookings</p></li>
            <li class="nav-item"><p class="nav-style nav-link text-white pb-1 my-0">Services</p></li>
            <li class="nav-item"><p class="nav-style nav-link text-white pb-1 my-0">FAQs</p></li>
            </ul>
