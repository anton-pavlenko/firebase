      ...
      <nav class="navbar-custom justify-content-center navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="w-100 collapse navbar-collapse" style="">
          <ul class="w-100 justify-content-center navbar-nav">
            <li class="nav-item"><p class="nav-link text-white pb-1 my-0" style="font-size:16px;font-weight:300">How It Works</p></li>
            <li class="nav-item"><p class="nav-link text-white pb-1 my-0" style="font-size:16px;font-weight:300">Recent Bookings</p></li><li class="nav-item"><p class="nav-link text-white pb-1 my-0" style="font-size:16px;font-weight:300">Services</p></li><li class="nav-item"><p class="nav-link text-white pb-1 my-0" style="font-size:16px;font-weight:300">FAQs</p></li></ul><ul class="ml-auto w-100 justify-content-end navbar-nav"><li class="nav-item"><a class="nav-link text-white pb-1 my-0" style="font-size:16px;font-weight:500" href="tel:18889534787">1-888-953-4787</a></li></ul></div></nav>
