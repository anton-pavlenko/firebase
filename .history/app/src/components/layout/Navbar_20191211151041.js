  ...
  return (
    ...
    {!isAuthHome ? 
      ...
      ( 
        ...
        <a href="#" className="d-flex w-50 mr-auto navbar-brand">
          <img
        ...
        <div
          ...
          id="navbarMenu"
        >
          <ul class="w-100 justify-content-end navbar-nav">
            <li class="nav-item"><p class="nav_text nav-link text-white pb-1 my-0">How It Works</p></li>
            <li class="nav-item"><p class="nav_text nav-link text-white pb-1 my-0">Recent Bookings</p></li>
            <li class="nav-item"><p class="nav_text nav-link text-white pb-1 my-0">Services</p></li>
            <li class="nav-item"><p class="nav_text nav-link text-white pb-1 my-0">FAQs</p></li>
            </ul>
            <ul class="ml-auto w-100 justify-content-end navbar-nav"><li class="nav-item"><a class="nav-link text-white pb-1 my-0" href="tel:18889534787">1-888-953-4787</a></li></ul>
        </div>
      </nav>
