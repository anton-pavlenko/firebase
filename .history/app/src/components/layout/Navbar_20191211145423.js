  ...
  return (
    ...
    {!isAuthHome ? 
      ...
      <nav class="navbar-custom justify-content-center navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="justify-content-end navbar-collapse collapse" id="navbarMenu" style=""><ul class="navbar-nav "><a href="#"><li class="nav-item"><a href="#" class="nav-link text-secondary">Dashboard</a></li></a><a href="/partner/myteam"><li class="nav-item"><a href="/partner/myteam" class="nav-link text-secondary">My Team</a></li></a><a href="/partner/myclient"><li class="nav-item"><a href="/partner/myclient" class="nav-link text-secondary">My Clients</a></li></a><a href="/partner/marketing"><li class="nav-item"><a href="/partner/marketing" class="nav-link text-secondary">Marketing</a></li></a><a href="/partner/settings"><li class="nav-item"><a href="/partner/settings" class="nav-link text-secondary">Settings</a></li></a><a href="/partner/login"><li class="nav-item"><a href="/partner/login" class="nav-link text-secondary">Logout</a></li></a></ul></div></nav>
