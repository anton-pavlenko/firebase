                                            ...
                                            <section>
                                                ...
                                                <div className="card_1 card">
                                                    <div className="tab-content">
                                                        ...
                                                        <div class="tab-pane"><div class="card-body"><form class="text-left mb-0"><section class="row"><section class="col-12"></section></section><section class="row form-group mb-xl-3 mb-lg-3 mb-md-0 mb-sm-0 mb-0"><section class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-xl-0 mb-lg-0 mb-md-1 mb-sm-1 mb-1"><textarea name="notes" id="notes" placeholder="What can we help you book?" class="col-12 form-control"></textarea></section></section><section class="row form-group"><section class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-xl-0 mb-lg-0 mb-md-1 mb-sm-1 mb-1"><input name="name" id="name" placeholder="Name" type="text" class="col-12 form-control"></input></section><section class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-xl-0 mb-lg-0 mb-md-1 mb-sm-1 mb-1"><input name="email" id="email" placeholder="Email" type="email" class="col-12 form-control"></section><section class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12"><div class="react-tel-input" style="color: rgb(0, 0, 0); height: 38px;"><input class="col-12 w-100 form-control" id="phone-form-control" placeholder="Phone" type="tel" value="+1" ><div class=" flag-dropdown" id="flag-dropdown" tabindex="0" role="button"><div class="selected-flag" title="United States: + 1"><div class="flag us"><div class="arrow"></div></div></div></div></div></section></section><section class="row text-center"><section class="col-12"><button type="submit" class="btn btn-primary" style="border: 2px solid rgb(255, 255, 255); border-radius: 0.25rem;">Submit</button></section></section></form></div></div>
                                                    </div>    
                                                </div> 
                                            </section>
                                    </section>
