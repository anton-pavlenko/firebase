                                                        ...
                                                        <div className="tab-pane active">
                                                            <div className="card-body">
                                                                ...
                                                                <section className="row form-group mb-xl-3 mb-lg-3 mb-md-0 mb-sm-0 mb-0">
                                                                    ...
                                                                    <section class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-xl-0 mb-lg-0 mb-md-1 mb-sm-1 mb-1"><div class="rbt clearfix open col-12 px-0" tabindex="-1" ><div class="rbt-input-hint-container" ><input aria-autocomplete="both" aria-expanded="false" aria-haspopup="listbox" autocomplete="nope" placeholder="Destination" role="combobox" type="text" class="rbt-input-main form-control rbt-input " value=""></input><input aria-hidden="true" readonly="" tabindex="-1" value=""></input><div class="rbt-input-hint"></div></div><div aria-atomic="true" aria-live="polite" class="sr-only rbt-sr-status" role="status">0 selections</div></div></section>
                                                                </section>
                                                                </form>
                                                            </div>
                                                        </div>
