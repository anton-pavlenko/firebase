...
<section class="col-2 d-none d-sm-none d-md-none d-lg-block d-xl-block"><div class="mb-3 card"><div class="dropdown show">
  <a class="btn btn-secondary dropdown-toggle" width="300px" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Users
  </a>
