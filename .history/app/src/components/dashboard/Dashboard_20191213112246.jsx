...
class Dashboard extends Component {
 ...
 handleClick() {
  ...
  <div class="input-group">
    <input type="tel" class="form-control"/>
    <span class="input-group-addon">Tel</span>
  </div><section class="d-flex align-items-center col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12"><div class="col-12 custom-checkbox custom-control"><input type="checkbox" name="contactClientFlight" id="contactClientFlight" class="custom-control-input"></input><label class="custom-control-label" for="contactClientFlight">Contact Client Directly?</label></div></section></section>
