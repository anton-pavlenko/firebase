                  ...
                  <div className="card-body">
                    <form className="text-left">
                      <section class="row">
                        ...
                        <section class="row form-group"><section class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 mb-xl-0 mb-lg-0 mb-md-1 mb-sm-1 mb-1"><input name="name" id="name" placeholder="Client Name" type="text" class="col-12 form-control"></input></section><section class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 mb-xl-0 mb-lg-0 mb-md-1 mb-sm-1 mb-1"><input name="email" id="email" placeholder="Client Email" type="email" class="col-12 form-control"></input></section><section class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 mb-xl-0 mb-lg-0 mb-md-1 mb-sm-1 mb-1"><div class="react-tel-input" ><input class="col-12 w-100 form-control" id="phone-form-control" placeholder="Client Phone" type="tel" value="+1" ></input><div class=" flag-dropdown" id="flag-dropdown" tabindex="0" role="button"><div class="selected-flag" title="United States: + 1"><div class="flag us"><div class="arrow"></div></div></div></div></div></section><section class="d-flex align-items-center col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12"><div class="col-12 custom-checkbox custom-control"><input type="checkbox" name="contactClientFlight" id="contactClientFlight" class="custom-control-input"><label class="custom-control-label" for="contactClientFlight">Contact Client Directly?</label></div></section></section>
                    </form>
                  </div>
                </div>
              </div>
