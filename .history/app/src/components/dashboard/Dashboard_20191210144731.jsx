                              ...
                              <div className="rw-calendar-transition-group">
                                ...
                                class="rw-calendar-transition rw-calendar-transition-right rw-calendar-transition-entered rw-calendar-month rw-nav-view rw-calendar-grid">
                                  <thead class="rw-calendar-head">
                                    <tr class="rw-calendar-row"><th class="rw-head-cell">Su</th><th class="rw-head-cell">Mo</th><th class="rw-head-cell">Tu</th><th class="rw-head-cell">We</th><th class="rw-head-cell">Th</th><th class="rw-head-cell">Fr</th><th class="rw-head-cell">Sa</th></tr></thead>
                                </table>
                              </div>
                            </div>
                          </section>
