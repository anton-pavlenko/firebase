                                    ...
                                    <tr role="row" class="rw-calendar-row">
                                      ...
                                      <tr role="row" class="rw-calendar-row">
                                        ...
                                        <tr role="row" class="rw-calendar-row">
                                          ...
                                          <td role="gridcell" title="January 3, 2020" aria-label="January 3, 2020" class="rw-cell rw-cell-off-range">03</td><td role="gridcell" title="January 4, 2020" aria-label="January 4, 2020" class="rw-cell rw-cell-off-range">04</td></tr></tbody>
                                </table>
                              </div>
                            </div>
                          </section>
