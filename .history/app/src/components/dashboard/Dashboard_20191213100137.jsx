                    ...
                    <form className="text-left">
                      <section class="row">
                        ...
                        <section className="row form-group mb-xl-3 mb-lg-3 mb-md-0 mb-sm-0 mb-0">
                          ...
                          <section class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 mb-xl-0 mb-lg-0 mb-md-1 mb-sm-1 mb-1"><div id="# of Depart Stops? (Optional)_input" role="combobox" aria-owns="# of Depart Stops? (Optional)_listbox" aria-expanded="false" aria-haspopup="true" aria-busy="false" aria-live="polite" aria-autocomplete="list" aria-disabled="false" aria-readonly="false" tabindex="0" class="col-12 px-0 rw-dropdown-list rw-widget"><div class="rw-widget-input rw-widget-picker rw-widget-container"><div class="rw-input rw-dropdown-list-input"><input tabindex="-1" class="rw-dropdown-list-autofill rw-detect-autofill rw-sr" value=""></input><span class="rw-placeholder"># of Depart Stops? (Optional)</span></div><span class="rw-select"><button role="presentational" aria-hidden="true" tabindex="-1" title="open dropdown" type="button" aria-disabled="false" aria-label="open dropdown" class="rw-btn rw-btn-select"><span aria-hidden="true" class="rw-i rw-i-caret-down"></span></button></span></div><div class="rw-popup-container rw-popup-transition-exited"> <div class="rw-popup-transition" value={this.state.value} onChange={this.handleChange} /><div class="rw-popup"><ul id="# of Depart Stops? (Optional)_listbox" tabindex="-1" class="rw-list" role="listbox" aria-labelledby="# of Depart Stops? (Optional)_input" aria-hidden="false" aria-live="polite"><li role="option" tabindex="-1" aria-selected="false" class="rw-list-option rw-state-focus" id="# of Depart Stops? (Optional)_listbox_active_option" >No Preference</li><li role="option" tabindex="-1" aria-selected="false" class="rw-list-option">Non-Stop</li><li role="option" tabindex="-1" aria-selected="false" class="rw-list-option">1 Stop</li><li role="option" tabindex="-1" aria-selected="false" class="rw-list-option">2+ Stops</li></ul></div></div></div></section>
